...
import 'package:profile_page/pages/name/edit_name.dart';
...
class _EditEmailState extends State<EditEmail> {
  static const String _title = 'What is your email?';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          buildTextBox(context, 'bob@yahoo.com'),
          SizedBox(height: 200),
  ...
  Widget buildSaveButton(BuildContext context) {
    return Container(
      ...
      child: OutlinedButton(
        ...
        onPressed: () {
          context.read<User>().email = controller.text;
          Navigator.pop(context);
        },
